...
export const translations = {
  ...
  crops_buy_sell: { en: 'Buy/Sell(किन/बेच)', ne: 'किन/बेच' },
  cash_transaction: { en: 'Cash Transaction(नगद कारोबार)', ne: 'नगद कारोबार' },
  ...
  gas: { en: 'Gas(ग्यास)', ne: 'ग्यास' },
  crop_weight_kg: { en: 'Crop Weight (in Kg)', ne: 'तौल (केजी)' },
  total_weight: { en: 'Weights(तौल)', ne: 'तौल' },
  rate_per_kg: { en: 'Rate per Kg(दर प्रति केजी)', ne: 'दर प्रति केजी' },
  crop_type: { en: 'Crop Type', ne: 'फसलको प्रकार' },
  ...
  total_amount: { en: 'Total (जम्मा रकम)', ne: 'जम्मा रकम' }, 
  ...
  // Dashboard
  total_to_collect: { en: 'To Collect', ne: 'जम्मा उठाउनु पर्ने' },
  total_to_pay: { en: 'To Pay', ne: 'जम्मा तिर्नु पर्ने' },
